	...
	for (int i=0; i<n; i++)
	{
		...
		if (fieldName)
		{
			...
			if (data)
			{
				...
				// createFieldValue()はファクトリーを使ってCVRMLFieldData型の派生クラスを
				// newしたものを返してくるので、使い終わったらdeleteが必要．
				delete data;
			}
		}
#ifdef DEBUG_SEARCH_NODES
